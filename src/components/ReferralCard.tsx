        ...
        <div className="border-t border-teal-100 pt-4 mt-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2.5 bg-zinc-50 hover:bg-zinc-100 disabled:bg-[var(--ink-raise)] disabled:text-[var(--fg-faint)] text-white rounded-xl transition-colors text-sm font-medium"
            >
